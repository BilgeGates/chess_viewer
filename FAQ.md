...
Chess Diagram Generator is a free, browser-based chess diagram generator that allows you to create high-quality images of chess positions using FEN notation. It's perfect for coaches, content creators, authors, and players who need professional chess diagrams.
...
Yes, Chess Diagram Generator is completely free and open-source. You can use it for personal or commercial projects without any restrictions.

### Can I use Chess Diagram Generator offline?

Currently, Chess Diagram Generator requires an internet connection to load piece images and assets. However, offline support via Progressive Web App (PWA) is planned for a future release.
...
Yes! Chess Diagram Generator is fully responsive and works on smartphones and tablets. However, the export feature works best on desktop browsers due to memory requirements for high-resolution images.
...
You can export images up to **12,800 × 12,800 pixels** (32× scale). However, most browsers limit canvas size to around **16,384 × 16,384 pixels**.
...
| YouTube thumbnail | JPEG | 16× | 9,600×9,600 |
| Chess book (print) | PNG | 24× | 12,800×12,800 |
| Poster | PNG | 32× | 12,800×12,800 |
| Email/document | PNG | 8× | 3,200×3,200 |

### Why is my export taking a long time?

Large exports (16×, 32×) require significant memory and processing power. Your browser needs to:
1. Create a large canvas (up to 655 million pixels)
...
- Use a lower scale (8× instead of 32×)
...
Not yet. Batch export is planned for a future release. Currently, you must export positions one at a time.
...
Yes! Chess Diagram Generator works on iOS devices with Safari 14+. However, high-resolution exports (16×+) may be limited by mobile device memory.
...
- 🐦 Follow development updates on social media
...
- ☕ Buy the developer a coffee (link in README)
...
**Maintained by:** Chess Diagram Generator Team
