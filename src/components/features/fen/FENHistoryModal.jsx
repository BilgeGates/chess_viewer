...
import { MiniChessPreview } from '@/components/board';
...
const FENHistoryModal = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl border border-gray-700/50 shadow-2xl w-full max-w-5xl max-h-[85vh] flex flex-col relative z-10 mx-auto"
        style={{
          pointerEvents: 'auto',
