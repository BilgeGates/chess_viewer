...
const PrimaryActions = memo(function PrimaryActions({
  ...
  return prevProps.copiedText === nextProps.copiedText && prevProps.tempColor === nextProps.tempColor;
});
